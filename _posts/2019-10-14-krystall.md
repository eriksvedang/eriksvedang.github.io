...
This was a piece of commisioned work for the University Museum of Bergen (Norway), in collaboration with exhibition designer [Adam Bartley](https://bartleyadam.myportfolio.com/). The goal was to create a simulator where the museum visitors can experiment with the basic rules of chrystal growth in a simplified and playful way.

The end result is a special built hardware interface with large control knobs that changes two different parameters &mdash; concentration and temperature, which are the two most important factors for chrystals forming (or dissolving). The simulation is in 2D to make it easier to understand.
